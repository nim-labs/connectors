...
class NimShotProcessorUI(NimProcessorUIBase, QtCore.QObject):
  ...
  def validate(self, exportItems):
    ...
    if not isValid:
      ...
      result = msgBox.information(None, "Export", message, QtGui.QMessageBox.Ok )
      return False
  ...
  def createHandleWidgets(self):
    handleWidget = QtGui.QWidget()
    handleLayout = QtGui.QVBoxLayout()

    handleLayout.setContentsMargins(0,0,0,0)
    handleWidget.setLayout(handleLayout)

    handleLabel = QtGui.QLabel("Handles:")
