...
class NimProcessorUIBase(IProcessorUI):
  ...
  def nim_jobChanged(self):
    ...
    #set jobName global
    #set jobNumber global
    nim_jobName = ''
    nim_jobNumber = ''
    nim_jobInfo = nimAPI.get_jobInfo(self.nim_jobID)
    if nim_jobInfo:
      if len(nim_jobInfo)>0:
        nim_jobName = nim_jobInfo[0]['jobname']
        nim_jobNumber = nim_jobInfo[0]['number']
    
    nimHieroConnector.g_nim_jobName = nim_jobName
    nimHieroConnector.g_nim_jobNumber = nim_jobNumber
  ...
  def nim_showChanged(self):
    ...
    if showname:
      ...
      nimHieroConnector.g_nim_showName = nim_showName
