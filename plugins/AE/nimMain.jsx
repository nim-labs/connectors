...
function getUserID(buttonsToDisable) {
    var savedUserID,
        ...
        guessedUserID = null;
    if (app.settings.haveSetting('NIM Settings', 'userID')) {
        savedUserID = app.settings.getSetting('NIM Settings', 'userID');
    ...
    if (envUser) {
        for (var x = 0; x < allUsersLength; x++) {
            if (envUser == allUsers[x].username.toLowerCase() || envUser == allUsers[x].full_name.toLowerCase()) {
                ...
                app.settings.saveSetting('NIM Settings', 'userID', guessedUserID);
...
function changeUserDialog(buttonsToDisable) {
    ...
    confirmButton.onClick = function() {
        ...
        app.settings.saveSetting('NIM Settings', 'userID', userID);
        userSelected();
